...
# names gives you the data elements
names(reg.summary)

# estimate of prediction error; looks like 10
...
In RStudio you can knit html-- it includes the plots, tables, and the formatted
markdown. Cool!
...
folds
# how balanced was it? shows counts for each number
table(folds)

cv.errors=matrix(NA,10,19)
for(k in 1:10){
  # train on all observations but those in the kth fold
...
# fraction of dev is like r-squared
